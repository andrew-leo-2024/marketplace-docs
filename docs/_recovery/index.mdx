...
**Source of truth.** The canonical data source is `/home/leo/Projects/Brainstorm/docs/MARKETPLACE_OPPORTUNITY_CATALOG.md` (1,740 lines, ~713 offerings). The 38 strategic source documents live at `/home/leo/Projects/Brainstorm/docs/docs/1.md` through `38.md` (535,856 lines total). This documentation site is a structured, navigable rendering of those sources.
...
## 16. Documentation Site Metadata
...
| **Source documents** | `/home/leo/Projects/Brainstorm/docs/docs/1.md` through `38.md` |
| **Theme** | Midnight Executive (Navy `#1E2761`, Ice Blue `#CADCFC`) |
| **Total pages (Phase 1-2)** | ~213 |
| **Total pages (Phase 3)** | ~450-500 |
...
## 17. User Preferences for Generated Content
...
- **Source everything** from the MARKETPLACE_OPPORTUNITY_CATALOG.md or the 38 source documents. Do not invent facts.
