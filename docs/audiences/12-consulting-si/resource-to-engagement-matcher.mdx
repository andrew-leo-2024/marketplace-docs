...
Bench costs and mismatches; AI matches consultant skills to engagement requirements

## Business Context

| Attribute | Value |
|---|---|
| **Business Process** | Staffing optimization |
...
```mermaid
graph LR
    A[Input] --> B[Resource-to-Engagement Matcher]
    B --> C[Processing]
    C --> D[Output]
    D --> E[Audit Trail]
```
